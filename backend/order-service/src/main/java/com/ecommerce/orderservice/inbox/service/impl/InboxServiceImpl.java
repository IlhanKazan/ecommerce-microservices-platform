package com.ecommerce.orderservice.inbox.service.impl;

import com.ecommerce.common.constant.InboxStatus;
import com.ecommerce.orderservice.inbox.entity.Inbox;
import com.ecommerce.orderservice.inbox.repository.InboxRepository;
...
public class InboxServiceImpl implements InboxService {
    ...
    public boolean isMessageProcessed(String messageId, String eventType, String payload) {
        try {
            ...
            log.warn("IDEMPOTENT KONTROL: Mesaj ({}) daha önce işlenmiş, pas geçiliyor.", messageId);
            return true;
        }
    }
}
